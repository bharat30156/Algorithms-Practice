...
public class Fibonacci {
	 ...
	 * 
	 * @param n The input n for which we have to detemine the fibonacci number Outputs the nth
	 * fibonnaci Number
	 */
	 ...
	 * save both memory and the. space Complexity will be O(1) Time Complexity will be O(n)
	 * 
	 */
