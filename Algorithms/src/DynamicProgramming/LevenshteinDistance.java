...
/**
 * 
 * Levenshtein Distance dynamic programming implement to show the differnce between two Strings  
 *
 */
public class LevenshteinDistance {
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Levenshtein distance between " + a + " and " + b + " is: ");
