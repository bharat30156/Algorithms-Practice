...
public class Palindrome {
	 ...
	 *  @return {@code true} if given String is palindrome otherwise {@code flase}
	 */
	...
	/**
	 * check if String is palindrome String or not using recursion 
	 * 
	 * @param s a String to check
	 ...
	 * 
	 * @param s a string to check
	 * @return {@code true} if a given string is palindrome, otherwise {@code false}
	 */
