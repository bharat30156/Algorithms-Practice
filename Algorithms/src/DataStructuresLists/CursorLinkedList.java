 ...
 * 
 *  A CursorLinkedList is an array version of linked List. Essentially you have an array of list nodes but instead of 
 *  each node contaning a pointer to the next item int the Linked Lists. each node element in the array contains the Index for the next node element.
 */
