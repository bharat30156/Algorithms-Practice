 ...
 * 
 * <p>
 * A priority queue adds elements into posiiton based on their priority. so teh most important elements are 
 * place dat the fornt of the top. In this example I give a number that are bigger, a higher priority. Queuus in theory have no 
 * fixed size but when using an array implemnetation it does 
 */
class PriorityQueue {
