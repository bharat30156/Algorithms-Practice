...
public class ColumnarTranspositionCipher {
	...
	public static final String ABECEDARIUM = "abcdefghijklmnopqrstuwvxyzABCDEFG" + "HIJKLMNOPQRSTUVWXYZ0123456789,.;-@";
	private static final String ENCRYPTION_FEILD = "=";
	private static final char ENCRYPTION_FEILD_CHAR = '=';
	 ...
	 * @param keyword string with keyboard being used 
	...
	/**
	 * Encrypts a certain with the columnar Transposition cipher Rule
	 * 
	 * @param Word Word being encrypted 
	 * @param KeyWord String with keyword being used 
	 * @param abecedarium string with the abecedarium being used. null for the default one
	 * @return a string with the word encrypted by the columnar Transposition Cipher Rule 
	 */
	public static String encrypter(String word, String keywod, String abecedarium)
	{
		ColumnarTranspositionCipher.keyword = keyword;
		if(abecedarium != null)
		{
	...
	/**
	 * Decrypts a certain encrypted String with Columnar transposition Cipher Rule 
	 * 
	...
	public static String decrypter()
	{
		...
		return wordDecrypted.replace(ENCRYPTION_FEILD, "");
	}
	
	/**
	 * Builds a table with the word to be encrypted in rows by the columnar transposotion Cipher rule 
	 * 
	...
	private static Object[][] tableBuilder(String word)
	{
		...
		//Fills in the respective numbers
		...
		for(int i = 1; i  <table.length; i++)
		{
			for(int j = 0; j < table[i].length; j++)
			{
				...
				{
					table[i][j] = ENCRYPTION_FEILD_CHAR;
				}
			}
		}
		return table;
	...
	/**
	 * Determines the number of rows the table should habve regarding the columnar Transposition cipher
	 * Rule 
	 * 
	 * @return an int with the number of teh rows that the table should have in order to respect the 
	...
	/**
	 * Creates an abecedarium wiotyh a specified ascii inded 
	 * 
	 * @param value number of character being used based on the ASCII Tbale 
	 */
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Word being used encrypted ->>> " + wordBeingEncrypted);
		System.out.println(
				"Word encrypted ->>>"
				+ ColumnarTranspositionCipher.encrypter(wordBeingEncrypted, keywordForExample));
		System.out.println("Word decrypted ->>>" + ColumnarTranspositionCipher.decrypter());
		System.out.println("\n## Encrypted Tbale ###");
		showTable();
	}
