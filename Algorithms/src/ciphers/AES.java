...
/**
 * 
 * this class is build to demonstrate the application of the AES_Algorithm on an single 128-Bit block 
 * of data 
 */
public class AES {
	/**
	 * Preclalculated values for x to the the power of 2 in Rijndaels galois field. Used as 'RCON'
	 * the key expansion	 
	 */
	...
	/**
	 *  Rijndael 5-box substitution table used for encryption in the subBytes steps, as well as the key 
	 *  expansion
	 */
	...
	//Inverse Rijndel S-box substitution table used for decryption in the subBytesDec step
	...
	// Precalculated lookup table for galois feild multiolication by 2 used in mixColums step
	// during encryption
	...
	/**
	 * Precalculated looup table for galois field multiplication by 3 used in the MixColums Step
	 * during encryption
	 */
	...
	// PreCalculated lookup table for galois field multiplication by 9 used in the MixColumns step 
	// during decryption
	...
	/**
	 * PreCalculated lookup table for galois field multiplication by 11 used in the mixColumns step during decryption 
	 */
	...
	/**
	 * Precalculated lookup table for galois field multiplication by 13 used in the MixColumns step 
	 * using decryption
	 */
	...
	/**
	 * PreCalculated lookup table for galois field multiplication by 14 used in the MixColumns step 
	 * during decryption
	 */
	...
	/**
	 * Subroutine of rijndael key expansion
	 * 
	 * @param t
	 * @param rconCounter
	 * @return
	...
	public static BigInteger scheduleCore(BigInteger t, int rconCounter)
	{
		...
		for(int i = 0; i < 4; i++)
		{
			...
			// replace bytes in orignal string 
	...
	/**
	 * Return an array of 10 + 1 round keys that are calculated by using rijndael key schedule 
	 * @param initalKey 
	...
	public static BigInteger[] keyExpansion(BigInteger initialKey)
	{
		...
		for(int i = 1; i < 11; i++)
		{
			...
			BigInteger t3 = t1.xor(prevKey[0]);
			
			//Joiun round key segments 
	...
	/**
	 * Representation of the input 128 bits block as an array of 8 bit integers
	 * 
	 * @param block of 128 bits integers
	 * @return array of 8- bits integers
	 */
	...
	/**
	 * Return the 128-bit bigIntger representation of the input of an array of 8 bit intgers.
	 * 
	...
	/**
	 * Substitutes 8-Bit long substrng of the input using S-Box and returns the result.
	 * 
	 * @param cipherText
	 * @return subtration Output
	 */
	...
	/**
	 * Substitues 8-bits long substring of the input using the inverse S-Box for decryption and retunr 
	 * the result 
	 */
